...
(function () {
  ...
  var KB = [
    ...
    { k: ["test", "tests", "assessment", "protocol", "measure", "metric", "battery", "dribbling", "dribble", "shooting", "shoot", "passing", "neuroscience", "neuro", "cognitive", "skill"], a: "We use 18 validated protocols — 30 m sprint, Illinois agility, vertical jump (CMJ), Yo-Yo / VO₂max, handgrip, FMS + Y-Balance, hop-test, reaction time, posture / FPI, anthropometry, plus football-skill tests (<b>dribbling speed</b>, <b>shooting</b>, <b>passing</b>) and a <b>neuroscience</b> cognitive test — all mapped to one athlete profile." },
    ...
    { k: ["certif", "enroll", "course", "training", "become", "get certified", "job", "earn", "money", "resource", "academy", "career", "iaidl"], a: "Every level starts with the prerequisite <b>IAIDL Basic</b> (the accredited International AI Driving License). Then you certify across <b>3 levels</b> — AI Football Analyst → Senior AI Performance Analyst → AI Scouting Coach — join our talent network and earn from your first engagement. <a href='certify.html' target='_blank' rel='noopener'>See the certification page →</a>" },
